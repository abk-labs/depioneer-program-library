...
import { SPL302_PROGRAM_ADDRESS } from '../programs';
import {
  expectAddress,
  expectSome,
...
export type CreateInstruction<
  TProgram extends string = typeof SPL302_PROGRAM_ADDRESS,
...
> {
  // Program address.
  const programAddress = SPL302_PROGRAM_ADDRESS;
